package com.example.mopapov2.Printing;
...
import com.example.mopapov2.DeviceConfig.BranchSetup;
import com.example.mopapov2.DeviceConfig.GlobalDeviceDetails;
import com.example.mopapov2.DeviceConfig.WelcomenSetup;
...
public class MopapoPrinter extends AppCompatActivity implements PrintingCallback {
    ...
    private void changePairAndUnpair() {
        if(Printooth.INSTANCE.hasPairedPrinter())
            mPairwithprinter.setText(new StringBuilder("Unpair")
